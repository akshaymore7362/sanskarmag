...
export function PageIntro({ eyebrow, title, intro }: Props) {
  return (
    <section className="page-intro-header-banner" style={{ margin: "-20px -40px 32px -40px", padding: "48px 40px 40px 40px", background: "linear-gradient(135deg, #102A43 0%, #0B1E30 60%, #0B1E30 100%)", borderRadius: "0 0 24px 24px", position: "relative", overflow: "hidden", borderBottom: "1px solid rgba(255, 255, 255, 0.12)" }}>
      {/* Background Subtle Gradient Wave Accent */}
      <div style={{ position: "absolute", top: 0, right: 0, width: "300px", height: "100%", opacity: 0.15, background: "radial-gradient(circle at 100% 0%, #102A43 0%, transparent 70%)", pointerEvents: "none" }} />
