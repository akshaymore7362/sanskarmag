...
export default async function BlogDetailPage({ params }: Props) {
  ...
  return (
    <main className="blog-detail-page site-shell inner-shell" style={{ background: "#F7F5F0", minHeight: "100vh", paddingBottom: "80px" }}>
      ...
      <section className="article-header-banner" style={{ margin: "-20px -40px 32px -40px", padding: "40px 40px 36px 40px", background: "linear-gradient(135deg, #151027 0%, #241548 60%, #080711 100%)", borderRadius: "0 0 24px 24px" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          {/* Breadcrumb */}
          <div style={{ fontSize: "12px", color: "#A78BFA", marginBottom: "16px", display: "flex", alignItems: "center", gap: "8px" }}>
            <Link href="/" style={{ color: "#A9A5B5" }}>Home</Link>
            <span>›</span>
            <Link href="/blogs" style={{ color: "#A9A5B5" }}>Blogs</Link>
            <span>›</span>
            <span style={{ color: "#F5B72E" }}>{article.category || "Article"}</span>
          </div>

          <span className="hero-gold-pill-sm" style={{ background: "#F5B72E", color: "#080711", padding: "3px 8px", borderRadius: "4px", fontSize: "10px", fontWeight: 800, textTransform: "uppercase" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px", fontSize: "13px", color: "rgba(248, 246, 241, 0.8)" }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontWeight: 700, color: "#FFFFFF" }}>
              <User size={14} style={{ color: "#F5B72E" }} /> {article.author || "Editorial Team"}
            </span>
            <span>•</span>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        <article className="article-body-content" style={{ color: "#17151C", fontSize: "17px", lineHeight: 1.75 }}>
          <p style={{ fontSize: "19px", fontWeight: 600, color: "#241548", lineHeight: 1.6, marginBottom: "24px" }}>
            {article.description}
          </p>

          {/* Pullquote Box with Left Gold Border */}
          <div style={{ background: "#FFFFFF", borderLeft: "4px solid #F5B72E", borderRadius: "0 12px 12px 0", padding: "24px 28px", margin: "32px 0", boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
            <p className="font-serif" style={{ fontSize: "20px", fontWeight: 800, color: "#151027", fontStyle: "italic", margin: 0, lineHeight: 1.4 }}>
              "{article.pullQuote || "AI will not replace humans. But humans who use AI will replace those who don't."}"
            </p>
          </div>

          <h2 className="font-serif" style={{ fontSize: "28px", fontWeight: 800, color: "#151027", marginTop: "36px", marginBottom: "14px" }}>
            Why It Matters
          </h2>
          ...
          <div style={{ background: "linear-gradient(135deg, #151027 0%, #241548 100%)", borderRadius: "16px", padding: "32px", color: "#FFFFFF", textAlign: "center", margin: "40px 0" }}>
            <h3 className="font-serif" style={{ fontSize: "24px", fontWeight: 800, marginBottom: "8px" }}>Subscribe to Our Weekly Newsletter</h3>
            <p style={{ color: "#A9A5B5", fontSize: "14px", marginBottom: "20px" }}>Get executive briefings, market analysis, and new article releases straight to your inbox.</p>
