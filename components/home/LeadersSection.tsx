  ...
  return (
    <section className="py-12 lg:py-16 px-4 md:px-12 max-w-[1280px] mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b-2 border-[#3B82F6] pb-4 mb-8 gap-4">
        ...
        <Link
          href="/leaders"
          className="text-[#1E3A8A] text-xs font-bold tracking-wider uppercase flex items-center gap-1 hover:text-[#1E3A8A] transition-colors whitespace-nowrap"
        >
        ...
        {featured && (
          <div className="lg:col-span-7 bg-white border border-gray-200 rounded-xl p-6 lg:p-8 flex flex-col md:flex-row gap-6 items-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-col flex-1">
              <span className="text-[#1E3A8A] font-bold text-xs tracking-wider uppercase mb-1 flex items-center gap-1">
          ...
          {supporting.map((leader, idx) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 min-w-0">
                <span className="text-[#1E3A8A] font-bold text-[10px] tracking-wider uppercase mb-1">
                  EXECUTIVE PROFILE
                </span>

                <h4 className="font-serif text-lg font-bold text-gray-900 line-clamp-1">
                  <Link href={`/leaders/${leader.slug}`} className="hover:text-[#1E3A8A] transition-colors">
                    {leader.name}
                  </Link>
                </h4>
