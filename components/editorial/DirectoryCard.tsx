...
export function DirectoryCard({ href, image, alt, eyebrow, title, description }: Props) {
  return (
    <Link href={href} className="bulletin-lead-card" style={{ padding: "24px", display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
      ...
      <div>
        <span className="hero-gold-pill-sm" style={{ fontSize: "10px", fontWeight: 800, color: "#102A43", letterSpacing: "1.5px" }}>{eyebrow || "SECTOR"}</span>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", fontWeight: 700, color: "#102A43" }}>
