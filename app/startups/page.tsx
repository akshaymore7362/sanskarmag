...
export default function StartupsPage() {
  return (
    <main className="startups-page site-shell inner-shell" style={{ background: "var(--editorial-ivory, #F7F5EF)", minHeight: "100vh", paddingBottom: "60px" }}>
      <PageIntro
        title="Startups"
      ...
      <div style={{ width: "100%", maxWidth: "100%", margin: "0 auto" }}>
        ...
        <section style={{ marginBottom: "48px" }}>
          <h2 className="font-serif" style={{ fontSize: "24px", fontWeight: 800, color: "#102A43", marginBottom: "20px" }}>Featured Startups</h2>
            ...
            {featuredStartups.map((startup) => {
              ...
              return (
                <div key={startup.name} style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: "16px", padding: "24px", textAlign: "center", boxShadow: "0 2px 10px rgba(0,0,0,0.03)" }}>
                  <div style={{ width: "56px", height: "56px", borderRadius: "14px", background: "rgba(30, 64, 175, 0.12)", color: "#102A43", display: "grid", placeItems: "center", margin: "0 auto 14px" }}>
                    <Icon size={28} />
                  </div>
                  <h3 className="font-serif" style={{ fontSize: "22px", fontWeight: 900, color: "#102A43", margin: "0 0 4px" }}>{startup.name}</h3>
                  ...
                  <Link href="/startups" style={{ fontSize: "11px", fontWeight: 700, color: "#102A43", border: "1px solid #102A43", padding: "6px 16px", borderRadius: "6px", display: "inline-block" }}>
                    View Profile
                  </Link>
                </div>
              );
        ...
        <section style={{ marginBottom: "48px" }}>
          <h2 className="font-serif" style={{ fontSize: "24px", fontWeight: 800, color: "#102A43", marginBottom: "20px" }}>Latest Startups</h2>
              ...
              return (
                <div key={item.name} style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: "14px", padding: "18px 24px", display: "flex", flexWrap: "wrap", gap: "16px", justifyContent: "space-between", alignItems: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                    ...
                    <div>
                      <h4 className="font-serif" style={{ fontSize: "18px", fontWeight: 800, color: "#102A43", margin: "0 0 2px" }}>{item.name}</h4>
